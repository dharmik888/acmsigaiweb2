...
const LightbulbIcon = () => (
  <svg width="40" height="40" viewBox="0 0 100 100" fill="none">
    <path d="M 30 50 Q 30 20 50 20 Q 70 20 70 50 Q 70 70 60 80 L 40 80 Q 30 70 30 50" fill="none" stroke="#000" strokeWidth="6" />
...
const CodeIcon = () => (
  <svg width="40" height="40" viewBox="0 0 100 100" fill="none">
    <path d="M 35 30 L 15 50 L 35 70" fill="none" stroke="#000" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M 65 30 L 85 50 L 65 70" fill="none" stroke="#000" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
    <line x1="60" y1="20" x2="40" y2="80" stroke="#000" strokeWidth="8" strokeLinecap="round" />
  </svg>
);

const PeopleIcon = () => (
  <svg width="40" height="40" viewBox="0 0 100 100" fill="none">
    <circle cx="30" cy="40" r="12" fill="#000" />
    <circle cx="70" cy="40" r="12" fill="#000" />
    <circle cx="50" cy="30" r="14" fill="#000" />
    <path d="M 10 90 Q 30 60 50 60 Q 70 60 90 90" fill="#000" />
  </svg>
);

const ChartIcon = () => (
  <svg width="40" height="40" viewBox="0 0 100 100" fill="none">
    <path d="M 10 90 L 90 90" stroke="#000" strokeWidth="6" strokeLinecap="round" />
    <path d="M 20 80 L 40 50 L 60 60 L 90 20" fill="none" stroke="#000" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M 70 20 L 90 20 L 90 40" fill="none" stroke="#000" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

const ACMLogoPlaceholder = () => (
  <svg width="60" height="60" viewBox="0 0 100 100" fill="none" className="bg-retroBlue rounded-full p-2 border-2 border-black">
    <text x="50" y="55" fontSize="28" fontWeight="bold" fill="#fff" textAnchor="middle">acm</text>
  </svg>
);
    ...
    <div className="space-y-8 pb-16">
      ...
      <section className="bg-retroYellow border-3 border-black rounded-3xl p-8 md:p-16 shadow-brutal-lg text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg font-bold text-black mb-4">
            ACM SIGAI TCET is the official student chapter of ACM at Thakur College of Engineering and Technology dedicated to Artificial Intelligence and Machine Learning.
          </p>
          <p className="text-base font-bold text-gray-800">
            We bring together passionate minds who are eager to explore, learn, and build innovative solutions using AI and ML technologies.
          </p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white border-3 border-black rounded-xl p-4 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-black text-lg uppercase tracking-tight text-black">LEARN</h3>
            <p className="text-sm font-medium text-gray-700 leading-snug mt-1">Workshops, seminars and tech talks by industry experts.</p>
          </div>
        </div>
        ...
        <div className="bg-white border-3 border-black rounded-xl p-4 flex items-start gap-4 relative overflow-hidden">
          ...
          <div>
            <h3 className="font-black text-lg uppercase tracking-tight text-black">BUILD</h3>
            <p className="text-sm font-medium text-gray-700 leading-snug mt-1">Hands-on projects, hackathons and research initiatives.</p>
          </div>
        </div>
        ...
        <div className="bg-white border-3 border-black rounded-xl p-4 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-black text-lg uppercase tracking-tight text-black">COLLABORATE</h3>
            <p className="text-sm font-medium text-gray-700 leading-snug mt-1">Connect with peers, mentor juniors and grow together.</p>
          </div>
        </div>
        ...
        <div className="bg-white border-3 border-black rounded-xl p-4 flex items-start gap-4 relative overflow-hidden">
          ...
          <div>
            <h3 className="font-black text-lg uppercase tracking-tight text-black">INNOVATE</h3>
            <p className="text-sm font-medium text-gray-700 leading-snug mt-1">Solve real-world problems using AI/ML technologies.</p>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white border-3 border-black rounded-xl p-5 flex flex-col items-start">
          ...
          <div className="flex items-center gap-3 w-full">
            ...
            <div className="flex flex-col">
              <span className="font-black text-black text-sm uppercase leading-tight">Association for <br /> Computing Machinery</span>
            </div>
          </div>
