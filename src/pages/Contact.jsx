...
const CheckItem = ({ text }) => (
  <li className="flex items-center gap-2 font-medium text-black">
    <span className="w-5 h-5 rounded-full bg-retroGreen border-2 border-black flex items-center justify-center text-white text-xs font-black flex-shrink-0">✓</span>
    {text}
  </li>
);
...
const ScheduleRow = ({ day, time, highlight }) => (
  <div className={`flex justify-between items-center py-2.5 border-b-2 border-black last:border-0 ${highlight ? "font-black" : "font-medium"}`}>
    <span>{day}</span>
    <span className={`text-sm px-3 py-0.5 rounded-full border-2 border-black ${highlight ? "bg-retroGreen text-white" : "bg-white text-black"}`}>{time}</span>
  </div>
);
  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="bg-retroYellow border-3 border-black rounded-3xl p-8 md:p-12 shadow-brutal-lg text-center relative overflow-hidden">
        ...
        <span className="bg-retroOrange text-black font-black text-xs px-4 py-1.5 border-2 border-black rounded-full uppercase tracking-wider inline-block mb-4">
          GET IN TOUCH
        </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border-3 border-black rounded-3xl p-6 shadow-brutal-lg flex flex-col gap-6">
          <div>
            ...
            <h2 className="text-2xl font-black mt-3 text-black">Talk to the TCET ACM SIGAI team</h2>
          ...
          {/* Reach us for */}
          <div>
            <p className="font-black text-black uppercase tracking-wider text-xs mb-3">You can reach us for:</p>
          ...
          {/* Direct links */}
          <div>
            <p className="font-black text-black uppercase tracking-wider text-xs mb-3">Direct links:</p>
          ...
          <div className="bg-white border-3 border-black rounded-3xl overflow-hidden shadow-brutal-lg">
            <div className="p-4 border-b-2 border-black flex items-center justify-between">
              <div>
                ...
                <h3 className="font-black text-black mt-2">Find us on the map</h3>
          ...
          <div className="bg-white border-3 border-black rounded-3xl p-6 shadow-brutal-lg">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <h3 className="font-black text-black mt-2">When are we usually active?</h3>
                <p className="text-gray-500 text-sm font-medium">Timings may shift during tests &amp; exams, but generally:</p>
              </div>
            ...
            <p className="text-sm text-gray-600 font-medium mt-3">
              Best time to catch us in person: <strong>shortly before / after lectures</strong> or during scheduled ACM activities.
            </p>
          </div>
        </div>
      </div>
